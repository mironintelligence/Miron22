## 3.1 Tarafların Rolleri

Veri Sorumlusu: Kullanıcı (platforma veri yükleyen avukat veya hukuk profesyoneli). Veri İşleyen: Miron AI. Miron AI, Kullanıcı adına ve Kullanıcı'nın talimatları doğrultusunda veri işlemektedir. Miron AI hiçbir koşulda veri sahibi konumuna geçmez.

## 3.2 Veri İşlemenin Amacı ve Hukuki Dayanağı
