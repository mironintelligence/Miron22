...
export function Ataturk() {
  return (
    <section className="bg-surface border-y border-border min-h-[55vh] flex items-center justify-center text-center px-6 py-[120px]">
      <Reveal>
        <blockquote className="font-display text-[clamp(22px,3.2vw,42px)] italic max-w-[820px] mx-auto mb-6 leading-[1.55]">
          "Hukuk, sırf akıl ve mantığa dayalı eski teorik kurallardan ibaret olmayıp,
        ...
        <p className="font-ui text-[11px] tracking-[0.22em] uppercase text-muted mb-14">
