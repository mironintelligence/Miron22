              ...
              {phase === 'result' && (
                <div className="flex flex-col gap-2.5">
                  {RESULTS.map((card) => (
                    ...
                    >
                      <span
                        className={`px-2.5 py-1 rounded text-[10px] tracking-[0.14em] uppercase min-w-[80px] text-center font-medium shrink-0 ${card.badgeClass}`}
                      >
                        {card.badge}
                      </span>
                      <div>
                        <p className="font-sub font-bold text-[14px] text-text mb-1">{card.title}</p>
