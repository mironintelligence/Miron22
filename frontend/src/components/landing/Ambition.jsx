      ...
      <Container>
        ...
        <Reveal delay={0.1}>
          ...
          <p className="font-ui font-light text-[14px] text-muted max-w-[520px] mx-auto mb-12 leading-relaxed">
            Ulusal ölçekte tanınan bir büro olmak farklı bir disiplin ister. Sistem kuran ekipler, 5 yıl sonra rakiplerini
            hatırlamaz.
          </p>
        </Reveal>
        ...
        <div className="max-w-[480px] mx-auto">
          <Reveal delay={0.15}>
            <p className="font-display italic text-[28px] text-muted">En iyi bürolar daha çok çalışmaz.</p>
          </Reveal>
