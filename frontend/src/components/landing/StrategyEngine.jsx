        ...
        <Reveal>
          <div className="max-w-[720px] mx-auto bg-surface border border-border rounded-lg overflow-hidden">
            ...
            <div className="bg-surface-2 border-b border-border p-4 flex items-center gap-3">
              ...
              <span className="font-ui text-[13px] text-white">Miron — Strateji Motoru</span>
            ...
            <div className="p-7 flex flex-col gap-5">
              {MESSAGES.map((msg, i) => (
                <motion.div
                  ...
                  className={`max-w-[85%] rounded-lg p-4 ${msg.bgClass} ${msg.side === 'right' ? 'self-end' : 'self-start'}`}
                >
                  {msg.label && (
