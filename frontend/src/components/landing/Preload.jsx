...
export function Preload() {
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-[#070707] flex flex-col items-center justify-center gap-6 transition-opacity duration-1000">
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 0.5, delay: 0.4 }}
      >
        <LandingLogo size="lg" withText={false} />
      </motion.div>
