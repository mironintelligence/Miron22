      ...
      <Container>
        <Reveal>
          ...
          <h2 className="font-display text-[clamp(28px,4vw,54px)] leading-[1.15] mb-6">
            Sıradan avukatlar dosya okuyor.
            <br />
            Kazananlar{' '}
          ...
          <Reveal variant="l">
            <div className="bg-surface border-t-2 border-gold p-[48px_44px] h-full">
              ...
              <div className="flex flex-col">
                {WINNERS.map((item) => (
                  <div key={item} className="border-b border-border last:border-0 py-4 flex gap-4 items-start">
              ...
              <div className="flex flex-col">
                {LOSERS.map((item) => (
                  <div key={item} className="border-b border-border last:border-0 py-4 flex gap-4 items-start">
                    ...
                    <span className="font-ui text-[14px] text-muted line-through opacity-60">{item}</span>
                  </div>
                ))}
              </div>
            </div>
